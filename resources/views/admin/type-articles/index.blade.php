...
@section('breacrumd')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Liste des types d'article
            </li>
        </ol>
    </div>
@endsection
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            <a href="{{route('type-bien.index')}}">
                                ...
                                <span>Tous les types d'article</span>
                            </a>
                        </div>
                        <a href="{{route('type-article.index')}}">
                ...
                <div class="card card-user-timeline">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title">Liste des types d'article </h4>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ route('type-article.create') }}" class="btn btn-sm btn-primary">
                                ...
                                <tbody id="myTable">
                                    @foreach ($all_types as $type)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('type-article.edit',$type->id)}}" class="btn btn-sm btn-success"> Modifier</a>
                                                <a href="{{route('type-article.destroy',$type->id)}}" class="btn btn-sm btn-danger"> Supprimer</a>
