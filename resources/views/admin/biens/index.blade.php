...
@section('breacrumd')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Liste des bien
            </li>
        </ol>
    </div>
@endsection
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            <a href="{{route('type-bien.index')}}">
                                <h3 class="fw-bolder mb-75">{{ $count_biens }}</h3>
                                <span>Tous des biens</span>
                            </a>
                        </div>
                        <a href="{{route('type-bien.index')}}">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card card-user-timeline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ route('bien.create') }}" class="btn btn-sm btn-primary">
                                    ...
                                    @foreach ($biens as $bien)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('bien.destroy',$bien->token)}}"
