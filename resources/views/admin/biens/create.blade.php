        ...
        <div class="card card-user-timeline">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="card-title">Formulaire de creation de bien </h4>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mt-1">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="beds" required min="0">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mt-1">
                            <div class="form-group">
                                <label for="baths">Nombre de salle de bain <span style="color: red">*</span></label>
                                <input type="number" class="form-control" name="baths" required min="0">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mt-1">
                            <div class="form-group">
                                <label for="garage">Nombre de garages <span style="color: red">*</span></label>
                                <input type="number" class="form-control" name="garage" required min="0">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mt-1">
                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea name="description" id="description" cols="30" rows="6" name="description" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
