...
@section('breacrumd')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Formulaire de creattion d'utilisateur
            </li>
        </ol>
    </div>
@endsection
        ...
        <div class="card card-user-timeline">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="card-title">Formulaire de creation d'utlisateur </h4>
                </div>
            </div>
            <form action="{{ route('user.store') }}" method="post" >
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label for="name">Nom de l'utlisateur <span style="color: red">*</span></label>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label for="email">Email de l'utlisateur <span style="color: red">*</span></label>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label for="role">Role assigné <span style="color: red">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label for="password">Mot de passe de l'utlisateur <span style="color: red">*</span></label>
