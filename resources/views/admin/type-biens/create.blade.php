...
@section('breacrumd')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Formulaire de creattion de type de bien
            </li>
        </ol>
    </div>
@endsection
        ...
        <div class="card card-user-timeline">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="card-title">Formulaire de creation de type de bien </h4>
                </div>
            </div>
            <form action="{{ route('type-bien.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
