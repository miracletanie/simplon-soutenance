...
@section('breacrumd')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Formulaire de creation d'article
            </li>
        </ol>
    </div>
@endsection
        ...
        <div class="card card-user-timeline">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="card-title">Formulaire de creation d'article </h4>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 mt-1">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" required class="form-control">
                                    <option value="">Selectionnez le type de article</option>
                        ...
                        <div class="col-lg-6 col-md-6 mt-1">
                            <div class="form-group">
                                ...
                                <textarea id="subtitle" cols="30" rows="6" name="subtitle" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 mt-1">
                            <div class="form-group">
                                ...
                                <textarea id="content" cols="30" rows="6" name="content" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mt-1">
                            <div class="form-group">
                                <label for="images">Images de l'article <span style="color: red">*</span></label>
