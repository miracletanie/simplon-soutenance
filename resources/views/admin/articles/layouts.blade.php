                    ...
                    <div class="position-relative">
                        ...
                        <div class="profile-img-container d-flex align-items-center">
                            ...
                            <div class="profile-title ms-3">
                                <h2 class="text-white">nom de l'article</h2>
                                <p class="text-white">Catégorie de larticle: </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <div class="profile-tabs d-flex justify-content-between flex-wrap mt-1 mt-md-0">
                                    <ul class="nav nav-pills mb-0">
                                        ...
                                        {{--
                                        <?php dd(Route::current()->getName() == 'article.followUp'); ?> --}}

                                        <li class="nav-item">
                                            <a class="@if (Route::current()->getName() == 'article.visite') active @endif nav-link fw-bold"
                                               href="#">
                                    ...
                                    <ul class="nav nav-pills float-right">
                                            ...
                                            <li class="nav-item me-1">
                                                ...
                                                <a href="{{ route('article.edit', $article->token) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" class="row gy-1 pt-75" action="#"
                        ...
                        <input type="hidden" name="client_id" value="{{$article->id}} ">
